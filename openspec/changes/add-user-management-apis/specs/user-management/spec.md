...
## Purpose
Provide comprehensive user management APIs for administrators to create, read, update, activate, deactivate, and soft-delete user accounts through a secure RESTful interface.
